...
struct ppcg_scop {
	...
	isl_union_map *retagged_reads;
	isl_union_map *retagged_must_writes;
	...
	isl_union_pw_multi_aff *cache_array_tagger;
	...
	isl_union_map *adjacent_dep_flow;
	isl_union_map *adjacent_dep_rar;
